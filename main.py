...
city_background = background.Background(city_back, window.screen, config.level/4)
mist_background = background.Background(mist_back, window.screen, config.level/2)
